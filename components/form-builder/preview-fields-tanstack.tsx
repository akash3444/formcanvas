...
export function TanstackPreviewField({ field, api }: TanstackPreviewFieldProps) {
  ...
  switch (field.type) {
    ...
    case "date": {
      ...
      let control: React.ReactNode
      if (field.mode === "range") {
        const value = asRangeValue(api.state.value)
        control = (
          <Popover>
            <PopoverTrigger
              render={
            ...
            <PopoverContent className="w-auto p-0" align="start">
              <Calendar
                ...
                selected={value}
                onSelect={(range) => api.handleChange(range)}
                disabled={disabled}
                autoFocus
              />
            </PopoverContent>
        ...
        const value = asDateValue(api.state.value)
        control = (
          <Popover>
            <PopoverTrigger
              render={
            ...
            <PopoverContent className="w-auto p-0" align="start">
              <Calendar
                ...
                captionLayout={field.captionLayout}
                selected={value}
                onSelect={(date) => api.handleChange(date)}
                disabled={disabled}
                autoFocus
              />
            </PopoverContent>
